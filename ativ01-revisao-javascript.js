...
// Poderia também ter feito a inclusão da seguinte forma:
...
// console.log(densidadeDemo(estado1.area, estado1.populacao))
// console.log(`O estado ${estado1.nome} possui uma densidade demográfica de ${densidadeDemo(estado1.area, estado2.populacao)}`)
// console.log('--------------------------------')
...
for(let i = 0; i < estadosNe.length; i++) {
    let result = densidadeDemo(estadosNe[i].area, estadosNe[i].populacao)
    estadosNe[i]["densidade demográfica"] = result
